...
namespace CloudBank.Helpers
{
    public static class IJSRuntimeExtensions
    {
        ...
        {
            return js.InvokeVoidAsync("saveAsFile", 
                fileName, 
        ...
        {
            return js.InvokeVoidAsync("Swal.fire", 
                title, 
                message, 
                sweetAlertMessageType.ToString());
        }
        ...
        {
            return js.InvokeAsync<bool>("CustomConfirm", 
                title, 
                message, 
                sweetAlertMessageType.ToString());
        }
